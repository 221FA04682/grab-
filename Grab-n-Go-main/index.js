...
function openWhatsapp() {
  ...
  if ($("#address")[0].value === "") {
    ...
    window.open("https://wa.me/916300381233?text=" + wTxtEncoded);
  }
}


function placeOrder() {
  const items = [...ar];  // Replace with your cart items
  const total_price = calculateTotalPrice(items);  // Replace with your total calculation
